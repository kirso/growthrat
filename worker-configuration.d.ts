/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file wrangler-types.env` (hash: 95c000dd05a5b26cb6e10e7e7387e685)
// Runtime types generated with workerd@1.20260504.1 2026-05-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GrowthRatAgent";
	}
	interface Env {
		SESSION: KVNamespace;
		...
		AI_CHAT_MODEL: "@cf/meta/llama-3.2-3b-instruct";
		AI_DAILY_CALL_LIMIT: "120";
		CHAT_DAILY_LIMIT: "80";
		KILL_SWITCH: "false";
		...
		PUBLIC_EVENT_DAILY_LIMIT: "5000";
		PUBLIC_SITE_URL: "https://growthrat.kirso.workers.dev";
		REVENUECAT_PROJECT_ID: "";
		REVENUECAT_ROLE: "agentic-ai-growth-advocate";
		GrowthRatAgent: DurableObjectNamespace<import("./src/worker").GrowthRatAgent>;
		WEEKLY_LOOP: Workflow<Parameters<import("./src/worker").GrowthRatWeeklyWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_MODE" | "AI_GATEWAY_ID" | "AI_CHAT_MODEL" | "AI_DAILY_CALL_LIMIT" | "CHAT_DAILY_LIMIT" | "KILL_SWITCH" | "LANGFUSE_BASE_URL" | "LANGFUSE_ENABLED" | "LANGFUSE_PROJECT_ID" | "LANGFUSE_SAMPLE_RATE" | "MAX_AI_OUTPUT_TOKENS" | "MAX_CHAT_MESSAGE_CHARS" | "MODEL_CHAT_ENABLED" | "PRODUCTION_WORKER_OBSERVED" | "PUBLIC_EVENT_DAILY_LIMIT" | "PUBLIC_SITE_URL" | "REVENUECAT_PROJECT_ID" | "REVENUECAT_ROLE">> {}
}
